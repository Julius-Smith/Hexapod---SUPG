...
#read in pickl
with open(r"C:\Users\Dell\Documents\University\Unversity2022\Thesis\Hexapod Code\Hexapod---SUPG\SUPG Julius\Pickles\SUPG_xor_cppn_testlowerCompat35.pkl", 'rb') as f:
    CPPN = pickle.load(f)
